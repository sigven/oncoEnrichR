...
DT::datatable(onc_enrich_report[['data']][['ppi']][['hubscores']], escape = F, extensions=c("Buttons","Responsive"), width = "100%",
  ...
  DT::formatStyle("symbol","hub_score", color = "white", backgroundColor = DT::styleInterval(onc_enrich_report[['config']][['target_disease']][['breaks']], onc_enrich_report[['config']][['target_disease']][['colors']]))
