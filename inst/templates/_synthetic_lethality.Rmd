...
crosstalk::bscols(
  list(
    crosstalk::filter_select("symbol_A", "Interactor A", sl_ab, ~symbol_A),
    crosstalk::filter_select("symbol_B", "Interactor B", sl_ab, ~symbol_B),
...
crosstalk::bscols(
  list(
    crosstalk::filter_select("symbol_A", "Interactor A", sl_a, ~symbol_A),
    crosstalk::filter_select("symbol_B", "Interactor B", sl_a, ~symbol_B),
