...
<span style="font-size: 100%; padding: 2px; background-color:#014587; color:white">&nbsp;&nbsp;<b>Citation Note</b>&nbsp;&nbsp;</span> : If you use the output of the *Synthetic lethality* module of oncoEnrichR in your research, please cite the following resources and tools:

 * [Nakken et al., arXiv, 2022](https://arxiv.org/abs/2107.13247) - *oncoEnrichR*
 * [De Kegel et al., Cell Syst, 2021](https://pubmed.ncbi.nlm.nih.gov/34529928/) - *Synthetic lethality predictions*
