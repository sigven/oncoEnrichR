...
<span style="font-size: 100%; padding: 2px; background-color:#014587; color:white">&nbsp;&nbsp;<b>Citation Note</b>&nbsp;&nbsp;</span> : If you use the output of the *Prognostic associations* module of oncoEnrichR in your research, please cite the following resources and tools:

 * [Nakken et al., Int J Cancer, 2023](https://doi.org/10.1002/ijc.34666) - *oncoEnrichR*
 * [Smith et al., Cell Rep, 2022](https://pubmed.ncbi.nlm.nih.gov/35354049/)
 * [Uhlen et al., Science, 2017](https://pubmed.ncbi.nlm.nih.gov/28818916/)
