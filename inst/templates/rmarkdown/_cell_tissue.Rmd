...
* Using data from the [Human Protein Atlas (HPA)](https://www.proteinatlas.org/humanproteome/tissue), we are here interrogating classification of all protein coding genes in the query set with respect to elevated expression in normal/healthy tissues and cell types
  * Gene expression per tissue is based on consensus data from HPA and [Genotype-Tissue Expression (GTEx) Project](https://gtexportal.org/home/), containing data from [50 distinct tissue types](https://www.proteinatlas.org/about/assays+annotation#gtex_rna). Gene expression measure unit: [_normalized_ transcripts pr million (nTPM)](https://www.proteinatlas.org/about/assays+annotation#normalization_rna)
  * RNA single-cell data comes from HPA, in which transcript expression levels are summarized per gene in 81 cell types from [31 datasets](https://www.proteinatlas.org/about/assays+annotation#singlecell_rna). Gene expression measure unit: [_normalized_ transcripts pr million (nTPM)](https://www.proteinatlas.org/about/assays+annotation#normalization_rna)
