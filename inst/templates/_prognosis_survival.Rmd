...
* Based on data recently calculated by [Smith et al., *bioRxiv*, 2021](https://www.biorxiv.org/content/10.1101/2021.06.01.446243v1), we here show the relative prognostic implications of genes in the query set, for different genetic features ( here limited to **expression**, **mutation**, **methylation**, and **CNA**).
