...
<br><br>
```{r tcga_ampl_plot, echo = F, eval = T, fig.height = onc_enrich_report[['config']][['tcga_aberration']][['plot_height']], fig.width = 13}
onc_enrich_report[['data']][['tcga_aberration']][['plot']][['cna_ampl']]

```
<br><br>
```{r tcga_homdel_plot, echo = F, eval = T, fig.height = onc_enrich_report[['config']][['tcga_aberration']][['plot_height']], fig.width = 13}
onc_enrich_report[['data']][['tcga_aberration']][['plot']][['cna_homdel']]
...
all_targets_vtypes <- dplyr::bind_rows(onc_enrich_report[['data']][['tcga_aberration']][['table']][['cna_homdel']],
                                       onc_enrich_report[['data']][['tcga_aberration']][['table']][['cna_ampl']])
