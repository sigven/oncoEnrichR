...
* Evidence for genes harboring tumor suppressive or oncogenic functions are provided with two levels of confidence:
    * <span style="background-color:#898989; padding:2x; color:white"><b>&nbsp;Strong&nbsp;</b></span> 
        * Record present in __at least two__ databases (CancerMine and NCG)
    * <span style="background-color:#BBBBBB; padding:2x; color:white"><b>&nbsp;Moderate&nbsp;</b></span>
        * Record present in __at least one__ database (CancerMine or NCG)
