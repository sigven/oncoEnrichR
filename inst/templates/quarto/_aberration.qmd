...
-   Frequencies across all subtypes per primary site are listed in an interactive table
    -   Only including genes that are aberrant in \>= 2 percent of samples for a given tumor type/subtype (with at least 25 samples in the cohort)
...
cat('\n <ul><li>  <i> <span style="font-size: 105%; padding: 3px; background-color:#989898; color:white">&nbsp;&nbsp;Heat map not shown - limited number of genes in the queryset are involved in recurrent copy number amplifications (<b>< 3, as reported in TCGA cohorts</b>)&nbsp;&nbsp; </span></i></li></ul>',sep='\n')
cat('\n')
cat('<br><br>')
...
cat('\n <ul><li>  <i> <span style="font-size: 105%; padding: 3px; background-color:#989898; color:white">&nbsp;&nbsp;Heatmap not shown - limited number of genes in the queryset are involved in recurrent homozygous deletions (<b>< 3, as reported in TCGA cohorts</b>)&nbsp;&nbsp; </span></i></li></ul>',sep='\n')
cat('\n')
cat('<br><br>')
...
crosstalk::bscols(
  list(
    crosstalk::filter_select(
      "primary_site", "Primary cancer site/tissue", oe_targets_tcga, ~primary_site),
    crosstalk::filter_select(
  ...
  list(
    crosstalk::filter_select(
      "primary_diagnosis", "Diagnosis", oe_targets_tcga, ~primary_diagnosis),
    crosstalk::filter_slider(
      "cohort_size", "Cohort Size", oe_targets_tcga, ~cohort_size)
  )
)
