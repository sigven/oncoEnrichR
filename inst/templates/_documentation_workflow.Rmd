...
* <i>Protein-protein interactions:</i>
  * `ppi_string_score_threshold` = __`r onc_enrich_report[['config']][['ppi']][['string']][['minimum_score']]`__
  * `ppi_biogrid_evidence_threshold` = __`r onc_enrich_report[['config']][['ppi']][['biogrid']][['minimum_evidence']]`__
  ...
  * `show_drugs_in_ppi` = __`r onc_enrich_report[['config']][['ppi']][['string']][['show_drugs']]`__
