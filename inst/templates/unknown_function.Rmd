...
* A set of _uncharacterized/poorly characterized human protein-coding genes (__n = `r NROW(oncoEnrichR::poorly_defined_genes)`__) _ have been established based on
...
* Target genes found within the set of poorly characterized genes are listed below, colored in varying shades of red according to the level of missing characterization (from <span style="background-color:#99000d; color:white">&nbsp;unknown function&nbsp;</span> to <span style="background-color:#fcbba1; color:white">&nbsp;poorly defined function&nbsp;</span>)
...
cat('<i>No genes with unknown or poorly defined functions were detected in target set.</i>',sep='\n')
cat('\n')
```
