...
* Here, we are showing, across the main primary tumor sites in TCGA:
  ...
  - Here, a maximum of _*n = 2,500_ top associations are shown per correlation direction (a more extensive set (maximum *n = 100,000* of top associations are listed in the Excel output of *oncoEnrichR*)
