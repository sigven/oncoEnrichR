...
* Each protein in the target set is annotated with:
   * Known associations to cancer phenotypes established from [multiple sources](https://docs.targetvalidation.org/getting-started/scoring) through the [Open Targets Platform](https://targetvalidation.org)
   * Status wrt. roles as tumor suppressors/oncogenes, fetched from the [CancerMine](https://www.nature.com/articles/s41592-019-0422-y) literature mining resource and the [Network of Cancer Genes](http://ncg.kcl.ac.uk/)
   * Target genes are colored in varying shades of blue according to their level of association to cancer (specifically the [maximum association score](https://docs.targetvalidation.org/getting-started/scoring) to a cancer phenotype at any level of resolution)
