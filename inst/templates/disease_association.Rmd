...
if(nrow(gene_enrich_report[['target_disease']]$target) > 0){
...
targets_shared <- crosstalk::SharedData$new(gene_enrich_report[['target_disease']]$target)
...
crosstalk::bscols(
  ...
  DT::formatStyle("symbol","ot_cancer_rank", color = "white", backgroundColor = DT::styleInterval(gene_enrich_report[['disease_rank']][['breaks']], gene_enrich_report[['disease_rank']][['colors']]))
)
