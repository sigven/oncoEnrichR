...
* Each protein in the target set is annotated with:
   ...
   * Target druggability (aka [_target tractability_](https://docs.targetvalidation.org/getting-started/target-tractability)), and targeted drugs for different cancer types 
   * Status wrt. roles as tumor suppressors/oncogenes, fetched from the [CancerMine](https://www.nature.com/articles/s41592-019-0422-y) literature mining resource and the [Network of Cancer Genes](https://cancer.sanger.ac.uk/census)
...
crosstalk::bscols(
  list(
    ...
    crosstalk::filter_select("oncogene", "Proto-oncogene", targets_shared, ~oncogene)
  ),
  list(
