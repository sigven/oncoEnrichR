...
if(nrow(onc_enrich_report[['data']][['target_disease']]$target) > 0){
...
targets_shared <- crosstalk::SharedData$new(onc_enrich_report[['data']][['target_disease']]$target)
...
crosstalk::bscols(
  ...
  DT::formatStyle("symbol","ot_cancer_rank", color = "white", backgroundColor = DT::styleInterval(onc_enrich_report[['config']][['target_disease']][['breaks']], onc_enrich_report[['config']][['target_disease']][['colors']]))
)
