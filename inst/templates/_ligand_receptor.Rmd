...
<span style="font-size: 100%; padding: 2px; background-color:#014587; color:white">&nbsp;&nbsp;<b>Citation Note</b>&nbsp;&nbsp;</span> : If you use the output of the *Ligand-receptor interactions* module of oncoEnrichR in your research, please cite the following resources and tools as appropriate:

 * **[Nakken et al., arXiv, 2022](https://arxiv.org/abs/2107.13247)** - *oncoEnrichR*
 * [Jin et al., Nat Commun, 2021](https://pubmed.ncbi.nlm.nih.gov/33597522/) - *CellChatDB*
