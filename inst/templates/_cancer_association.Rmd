...
* Evidence for genes harboring tumor suppressive or oncogenic functions are provided with three levels of confidence:
    * <span style="background-color:#5A5A5A; padding:2x; color:white"><b>&nbsp;Very Strong&nbsp;</b></span>
        * Manually curated entry in NCG or CGC, and with _significant support (> 10 citations)_ in the biomedical literature (CancerMine), **OR**
        * _Strong_support (> 20 citations)_ in the biomedical literature, no entry in NCG/CGC
