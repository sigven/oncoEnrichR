...
```{r lof_crispr_plot, echo = F, results = "asis", eval = nrow(onc_enrich_report[['data']][['crispr_ps']][['fitness_scores']][['targets']]) > 0, fig.width = 11, fig.height = onc_enrich_report[['config']][['crispr_ps']][['plot_height_fitness']]}
  ...
  crispr_lof_oe_plot <- onc_enrich_report[['data']][['crispr_ps']][['fitness_scores']][['targets']] %>%
...
plotly::ggplotly(crispr_lof_oe_plot)
rm(crispr_lof_oe_plot)
#plotly::ggplotly(onc_enrich_report[['data']][['crispr_ps']][['fitness_scores']][['plot']])

```


```{r crispr_missing_plot, echo=F, results = 'asis', eval = onc_enrich_report[['data']][['crispr_ps']][['fitness_scores']][['n_targets']] == 0}
...
```{r lof_crispr_table, echo=F, results = "asis", eval = onc_enrich_report[['data']][['crispr_ps']][['fitness_scores']][['n_targets']] > 0}

htmltools::br()

lof_oe_df <- onc_enrich_report[['data']][['crispr_ps']][['fitness_scores']][['targets']] %>%
...
lof_oe_table <- 
  crosstalk::SharedData$new(lof_oe_df)
rm(lof_oe_df)
...
```{r crispr_missing_data, echo=F, results = 'asis', eval = onc_enrich_report[['data']][['crispr_ps']][['fitness_scores']][['n_targets']] == 0}
...
```{r target_priority_heatmap, echo = F, eval = onc_enrich_report[['data']][['crispr_ps']][['target_priority_scores']][['n_pri_targets']] > 4}
...
```{r crispr_missing_priority, echo=F, results = 'asis', eval = onc_enrich_report[['data']][['crispr_ps']][['target_priority_scores']][['n_pri_targets']] < 5}

cat('<br>\n <ul><li>  <i> <span style="font-size: 105%; padding: 3px; background-color:#989898; color:white">&nbsp;&nbsp;<b>NO/LIMITED GENES</b> in the query set nominated as prioritized targets in Project Score.&nbsp;&nbsp; </span></i></li></ul>',sep='\n')
cat('\n')
