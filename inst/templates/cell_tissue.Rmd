...
crosstalk::bscols(
  ...
  list(
    crosstalk::filter_select("tissue", "Tissues", tissue_specs_per_gene, ~category)
  )
)
...
cat("<ul><li>")
cat('<i><font style="font-size: 100%">Considering the tissue specificities of members of the target set, <b>NO TISSUES</b> are enriched (adjusted p-value < 0.05) compared to the background set.</i></font>', sep='\n')
cat('</ul></li>')
