...
cat('<i>No genes in target set with strong positive correlations to tumor suppressors, oncogenes or cancer drivers</i>',sep='\n')
cat('\n')
```
...
cat('<i>No genes in target set with strong negative correlation to tumor suppressors, oncogenes or cancer drivers</i>',sep='\n')
cat('\n')
```
