...
* Using RNA-seq data from TCGA, a co-expression correlation matrix (Pearson rank correlation coefficient) was calculated, indicating pairs of genes that have their expression patterns correlated in tumors
* Here, we are showing, across the main primary tumor sites in TCGA:
  2) Tumor suppressor genes, proto-oncogenes or cancer driver genes with a **strong/very strong** correlation (negative or positive) to genes in the target set
...
crosstalk::bscols(
  ...
  list(
    crosstalk::filter_select("oncogene", "Oncogene (partner)", coexp_genes_positive, ~oncogene),
    crosstalk::filter_select("cancer_driver", "Cancer driver (partner)", coexp_genes_positive, ~cancer_driver),
...
crosstalk::bscols(
  ...
  list(
    crosstalk::filter_select("oncogene", "Oncogene (partner)", coexp_genes_negative, ~oncogene),
    crosstalk::filter_select("cancer_driver", "Cancer driver (partner)", coexp_genes_negative, ~cancer_driver),
