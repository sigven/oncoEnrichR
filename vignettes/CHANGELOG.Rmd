...
* Functionality
  ...
  * *Proto-oncogene/tumor suppressor annotation*
    * A more conservative approach for proto-oncogene and tumor suppressor status is implemented, requiring support from _at least two_ distinct resources (Network of Cancer Genes (NCG), Cancer Gene Census, or CancerMine)
  ...
  * Renamed arguments to `onco_enrich()` for improved consistency:
