...
* New section: *Synthetic lethality* - shows how members of the queryset overlaps with predicted synthetic lethality interactions (as published by De Kegel et al., Cell Systems, 2021)
...
* Sections that include *tabsets* are now organized so that the active tab
