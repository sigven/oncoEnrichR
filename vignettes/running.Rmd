...
-   Loads (from a version-specific [Zenodo record](https://doi.org/10.5281/zenodo.6684347)) all the necessary annotation datasets used in oncoEnrichR
...
and produced the [following HTML report with results](https://doi.org/10.5281/zenodo.6630473).
