...
This article describes the underlying annotation sources of _oncoEnrichR_ in detail, and to what extent they are subject to quality control/filtering for use within the package. 
